		...
		try{
			...
			if(a!=0){
				for(int i=0;i<count;i++){
						s1=new String(request.getParameter(i+"count").getBytes("ISO8859-1"),"gb2312");//产品名
						s2=new String(request.getParameter(i+"count1").getBytes("ISO8859-1"),"gb2312");//单价
						s3=new String(request.getParameter(i+"count2").getBytes("ISO8859-1"),"gb2312");//单位
						s4=new String(request.getParameter(i+"count3").getBytes("ISO8859-1"),"gb2312");//数量
