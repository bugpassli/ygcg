...
<div class="tab-pane fade in active">
		...
		<div class="panel panel-info">
			...
			<table class="table">
				<th>产品</th><th>提供价格</th><th>单位</th><th>备注</th>
				...
				<tr>
					...
					<td><input type="text" id="<%=i%>count2" name="<%=i%>count2"  class="form-control" style="width:30%" value=" <c:out value='${row.danwei}'/> "  readonly= "true"></td>
					<input type="hidden" name="<%=i%>count3"  class="form-control" style="width:30%" value="159357.111"></input>
...
%>
 ...
 <input type="hidden" id="cpsl"  name="cpsl" value="<%=i%>"/></input>
		...
		<div class="container">
		<input type="submit"  class="btn btn-info btn-lg btn-block" value="提交"  ></input>
		</div>
		</form>
